...
def _get_parser():
    ...
    parser.add_argument('--display-step', type=int, default=1, help='track metrics and iamges on tensorboard every # steps')

    parser.add_argument('--lambda-z', type=float, default=10, help='lambda for z recon loss')
    parser.add_argument('--lambda-softmin-proto', type=float, default=10, help='lambda for softmin prototype recon loss')
    parser.add_argument('--lambda-r1', type=float, default=10, help='lambda for R1 loss')
    parser.add_argument('--lambda-r2', type=float, default=10, help='lambda for R2 loss')
    parser.add_argument('--lambda-enc-mse', type=float, default=10, help='lambda for encoder MSE loss')
    # TODO add description
    parser.add_argument('--lambda-ad', type=float, default=10, help='lambda for AD loss')
    # TODO add description
    parser.add_argument('--train-weighted-protos', action='store_true', help='lambda for X loss')
