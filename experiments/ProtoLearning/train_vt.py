...
from experiments.ProtoLearning.models.vt import VT
...
def train(model, data_loader, log_samples, optimizer, scheduler, writer, cur_epoch, config):
    ...
    os.environ["WANDB_API_KEY"] =  "13e9dc8680a8414929806c079b4039d25b576edd"
    ...
    for e in range(cur_epoch, config['epochs']):
        ...
        if (e + 1) % config['save_step'] == 0 or e == config['epochs'] - 1 or e == 0:
            ...
            utils.plot_test_examples(log_samples, model, writer, logger, config, step=e)
