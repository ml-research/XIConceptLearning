...
class RAE(nn.Module):
    def __init__(self, input_dim=(1, 1, 28, 28),
        ...
        # TODO: the learnable mixture function, ie. learns the combination of different attribute prototypes -> make this more complex, e.g. some form of attention?
    ...
    def forward(self, x, noise_std=0.001):
        ...
        # reconstruct the prototype via the decoder
...
class PrototypeLayer(nn.Module):
    def __init__(self, input_dim=10, n_prototype_groups=2, n_prototype_vectors_per_group=5):
        ...
        self.prototype_vectors = torch.nn.Parameter(torch.rand(n_prototype_groups, n_prototype_vectors_per_group,
                                                               input_dim))
        # self.prototype_vectors = torch.nn.Parameter(torch.rand(n_prototype_vectors_per_group,
        #                                                        input_dim))
